...
* Branching
* Pull Requests (PRs)
* Things I wish I knew about working in a team with git & github 18 months ago...
* Troubleshooting:  
* Questions
...
Does a relevant issue ticket already exist?  
  * If NO: make a new one (see previous advice on how to write a good one!)  
  * If YES: fine, proceed...  

Is the issue ticket up-to-date with information from the latest work?  
  * If YES: all is well!.  
  * If NO: update it!  
...
Issue branches are ways of isolating out work done on specific tasks (or issues), with one or more commit.
...
- 'Git Pull' regularly and before starting any new work (avoids conflicts later)
...
If you have any problems or questions going forward as you start to use git & github, feel free to give me a shout!