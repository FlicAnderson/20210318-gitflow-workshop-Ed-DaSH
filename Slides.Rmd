...
View side-by-side changes included in commits

Don't commit everything - avoid commiting big files by adding to `.gitignore` file
...
<div class="centered">
```{r, out.width = "650"}
knitr::include_graphics("images/partycat.png")
``` 
</div>
